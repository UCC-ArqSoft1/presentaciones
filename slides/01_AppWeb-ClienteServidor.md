...
¿Querés aprender un poco más de POSTMAN?
Te recomiendo este curso:

[Postman Tutorial](https://testautomationu.applitools.com/postman-tutorial/)

[Exploring Service Apis Through test automation](https://testautomationu.applitools.com/exploring-service-apis-through-test-automation/index.html)

(Si bien ambos cursos están enfocados en testing son GRATUITOS y ofrecen certificados! (que puedes postear en linkedin) )
